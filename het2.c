...
void fhet1_(long long int*,long long int*,double*,double*,long long int*,long long int*,long long int*,double*,double*,double*,long long int*,long long int*,long long int*,double*);

void mexFunction(int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[])
{
    long long int *nx,*ny;
    long long int *jfonte,*ifonte,*parq,*N,*tipo,*fonte;
    double *dx,*dt,*atraso,*LT,*cw,*mate;
    ...
    mate = (double*)mxGetData(prhs[13]);

    fhet1_(nx,ny,dx,dt,N,jfonte,ifonte,atraso,LT,cw,parq,tipo,fonte,mate);
    return;
}